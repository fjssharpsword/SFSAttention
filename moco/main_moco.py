...
def main_worker(gpu, ngpus_per_node, args):
    ...
    summary_writer = SummaryWriter('/data/tmpexec/tensorboard-log/') if args.rank == 0 else None
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            if epoch % 50 == 0:
                ...
                }, is_best=False, filename='logs/checkpoint_%04d.pth.tar' % epoch)
...
#nohup python main_moco.py --gpu=1  > logs/train.log 2>&1 &