...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        #optional attentions
        #self.attlayer = SELayer(self.inplanes, reduction=16)
        #self.attlayer = ECA_layer(channel=self.inplanes, k_size=3)
        self.attlayer = SNALayer(channels=self.inplanes)
