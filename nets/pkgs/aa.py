...
if __name__ == "__main__":
    # Example Code
    tmp = torch.randn((16, 3, 32, 32)).cuda()
    augmented_conv1 = AugmentedConv(in_channels=3, out_channels=32, kernel_size=3, dk=40, dv=4, Nh=4, relative=True, stride=2, shape=16).cuda()
    ...
    augmented_conv2 = AugmentedConv(in_channels=3, out_channels=32, kernel_size=3, dk=40, dv=4, Nh=4, relative=True, stride=1, shape=32).cuda()
