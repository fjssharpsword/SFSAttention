...
def main():
    ...
    for s in selected_speakers:
        k = s
        speaker_dicts['p' + str(s)] = (root + 'Demo/VCTK-corpus/p' + str(k) + '/p' + str(k) + '_023.wav', selected_speakers.index(s))
    ...
    for key, wave in converted_samples.items():
        ...
        with open(root + 'Demo/chn-corpus/' + key + "-" + src_key + '_style.wav', 'wb') as f:
            f.write(file.data)
